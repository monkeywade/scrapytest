...
DEFAULT_REQUEST_HEADERS = {
  'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8',
   'Accept-Encoding': 'gzip, deflate',
    ...
    'referer': 'http://172.16.169.200:8080/zabbix.php?action=problem.view&ddreset=1',
    'Cookie': 'PHPSESSID=rc1obu3btn164bmrotdvbl07of; zbx_sessionid=97a154d27dff505dfa5324d357a21c22',
